process SPLIT_FASTA {
    ...
    chmod +x /mnt/workflow/definition/mag-v3.4.2/bin/split_fasta.py

    python3 /mnt/workflow/definition/mag-v3.4.2/bin/split_fasta.py $unbinned ${params.min_length_unbinned_contigs} ${params.max_unbinned_contigs} ${params.min_contig_size}
