include { SHORTREAD_BINNING_PREPARATION } from '../local/binning_preparation_shortread'
include { LONGREAD_BINNING_PREPARATION  } from '../local/binning_preparation_longread'
