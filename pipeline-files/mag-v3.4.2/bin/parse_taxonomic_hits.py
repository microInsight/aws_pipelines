...
def process_sylph(taxhits, target_list, gtdbtk_fn, min_frac):
	...
	syl_merge['Species'] = syl_merge['Species1'].str.replace('s__', '').str.replace('g__',
...
def parse_args():
	description = "'Filter Kraken2, Centrifuger or Sylph results against a database of target species. " \
